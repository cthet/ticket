...
public class TicketControllerTest {
    ...
    void givenNonexistentAgent_whenAssigningToTicket_thenThrowException() throws Exception {
        ...
        mockMvc.perform(put("/tickets/{id}/agent/{agentIdentifier}", ticketId, nonExistentAgentId)
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isBadRequest())
    ...
    void givenNonexistentTicket_whenAssigningAgent_thenThrowException() throws Exception {
        ...
        mockMvc.perform(put("/tickets/{id}/agent/{agentIdentifier}", nonexistentTicketId, agentId)
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    void givenTicketInProgress_whenResolving_thenStatusIsResolved() throws Exception {
        Long ticketId = 1L;
        String agentName = "Agent001";
        String ticketDescription = "Description";
    ...
    void givenClosedTicket_whenResolving_thenThrowException() throws Exception {
        Long ticketId = 1L;

        when(ticketService.resolveTicket(ticketId))
                .thenThrow(new InvalidTicketStateException(ErrorMessages.ONLY_TICKETS_IN_PROGRESS_CAN_BE_RESOLVED));
    ...
    void givenClosedTicket_whenUpdating_thenThrowException() throws Exception {
        Long ticketId = 1L;
    ...
    void givenNonexistentTicket_whenResolving_thenThrowException() throws Exception {
        Long nonexistentTicketId = 999L;
    ...
    void givenNonexistentTicket_whenClosing_thenThrowException() throws Exception {
        Long nonexistentTicketId = 999L;
    ...
    void givenTicketNotInResolvedState_whenClosing_thenThrowException() throws Exception {
        ...
        when(ticketService.closeTicket(ticketId))
                .thenThrow(new InvalidTicketStateException(ErrorMessages.ONLY_RESOLVED_TICKETS_CAN_BE_CLOSED));
    ...
    void givenNonexistentTicket_whenUpdating_thenThrowException() throws Exception {
        Long nonexistentTicketId = 999L;
        String ticketDescription = "Updated ticket description";
    ...
    void givenNonexistentTicket_whenGettingTicket_thenThrowException() throws Exception {
        Long nonexistentTicketId = 999L;
